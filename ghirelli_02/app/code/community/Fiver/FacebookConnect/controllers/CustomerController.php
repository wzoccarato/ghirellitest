<?php
class Fiver_FacebookConnect_CustomerController extends Mage_Core_Controller_Front_Action {
    ...
    public function LoginAction()
    {
        ...
        if (!is_null($me)) {
            ...
            $sql = 'SELECT `customer_id`
					FROM `' . $tablePrefix . 'fiver_facebook_customer`
					WHERE `fb_id` = ' . $me['id'] . '
					LIMIT 1';
            ...
            if ($data) {
                ...
                if ($r) {
                    ...
                    $sql = 'INSERT INTO `' . $tablePrefix . 'fiver_facebook_customer`
