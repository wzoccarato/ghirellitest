...
class Fiver_RevSlideshow_Block_Adminhtml_Slideshow_Captions_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	/**
	...
	*/
    ...
    $fieldset->addType('layer','Fiver_RevSlideshow_Block_Adminhtml_Slideshow_Captions_Form_Element_Layer');
