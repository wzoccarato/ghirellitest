...
class Fiver_RevSlideshow_Helper_Image extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 *
	 * @param Fiver_AttributeSplash_Model_Page $page
	 * @param string $attribute
	 * @return Fiver_AttributeSplash_Helper_Image
	 */
	public function init(Fiver_AttributeSplash_Model_Page $page, $attribute = 'image')
	{
