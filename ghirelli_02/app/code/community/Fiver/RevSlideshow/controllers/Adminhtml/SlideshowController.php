...
class Fiver_RevSlideshow_Adminhtml_SlideshowController extends Mage_Adminhtml_Controller_Action
{
	...
	public function savecaptionsAction()
	{
		...
		if ($json) {
			try {				
				$tableName = Mage::getSingleton("core/resource")->getTableName('revslideshow_slideshow');
	 ...
	 *
	 * @param Fiver_RevSlideshow_Model_Slideshow $slideshow
	 * @param string $field = 'image'
	 */
	protected function _handleImageUpload(Fiver_RevSlideshow_Model_Slideshow $slideshow, $field = 'image')
	{
	 ...
	 *
	 * @return null|Fiver_RevSlideshow_Model_Slideshow
	 */
